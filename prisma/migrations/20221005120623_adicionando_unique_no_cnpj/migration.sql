/*
  ...
  - A unique constraint covering the columns `[cnpj]` on the table `tblempresa` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `tblempresa_cnpj_key` ON `tblempresa`(`cnpj`);
