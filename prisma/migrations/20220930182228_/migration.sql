/*
  ...
  - You are about to drop the column `id_empresa` on the `tblendereco_empresa` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `tblendereco_empresa` DROP FOREIGN KEY `tblendereco_empresa_id_empresa_fkey`;
...
-- AlterTable
ALTER TABLE `tblendereco_empresa` DROP COLUMN `id_empresa`;
