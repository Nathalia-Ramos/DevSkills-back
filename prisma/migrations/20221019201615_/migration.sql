/*
  ...
  - You are about to drop the column `id_questao` on the `tblalternativa_prova` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `tblalternativa_prova` DROP FOREIGN KEY `tblalternativa_prova_id_questao_fkey`;
...
-- AlterTable
ALTER TABLE `tblalternativa_prova` DROP COLUMN `id_questao`;
