/*
  ...
  - You are about to drop the column `link_portifolio` on the `tblusuario` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `tblusuario` DROP COLUMN `link_portifolio`,
    ADD COLUMN `link_portfolio` TEXT NULL,
