/*
  ...
  - You are about to drop the `tblDenuncia` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE `tbladmin_denuncia` DROP FOREIGN KEY `tbladmin_denuncia_id_denuncia_fkey`;

-- DropForeignKey
ALTER TABLE `tbldenuncia_todos_motivos` DROP FOREIGN KEY `tbldenuncia_todos_motivos_id_denuncia_fkey`;
