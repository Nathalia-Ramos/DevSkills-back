/*
  ...
  - You are about to drop the column `permissao_email` on the `tblusuario` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `tblusuario` DROP COLUMN `permissao_email`,
    ADD COLUMN `permissa_email` BOOLEAN NOT NULL;
