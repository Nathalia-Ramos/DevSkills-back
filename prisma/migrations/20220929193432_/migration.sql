/*
  ...
  - You are about to drop the column `createdAt` on the `tblavaliacoes` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAt` on the `tblavaliacoes` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `tblavaliacoes` DROP COLUMN `createdAt`,
