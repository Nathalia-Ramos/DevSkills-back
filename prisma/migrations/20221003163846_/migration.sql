/*
  ...
  - Added the required column `updatedAt` to the `tblempresa_telefone` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `tblempresa_telefone` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
