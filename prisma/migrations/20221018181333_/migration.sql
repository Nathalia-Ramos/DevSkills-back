/*
  ...
  - Added the required column `id_questao_prova` to the `tblresposta_questao_prova` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `tblresposta_questao_prova` ADD COLUMN `id_questao_prova` INTEGER NOT NULL;
