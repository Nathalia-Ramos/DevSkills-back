/*
  ...
  - A unique constraint covering the columns `[cpf]` on the table `tblusuario` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `tblusuario_cpf_key` ON `tblusuario`(`cpf`);
